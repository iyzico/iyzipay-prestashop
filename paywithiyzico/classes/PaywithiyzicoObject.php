...
include_once 'PaywithiyzicoHelper.php';

class PaywithiyzicoObject
{
     ...
     * @return stdClass
     */
    public static function option($params, $context)
    {
        ...
        $paywithiyzico->currency = $thisUserCurrency;
    ...
    public static function basketItems($items, $shipping)
    {
        ...
        foreach ($items as $item) {
            ...
            $basketItems[$keyNumber]->price             = PaywithiyzicoHelper::priceParser($item['total_wt']);
        ...
        if (!empty($shipping)) {
            ...
            $basketItems[$keyNumber]->price             = PaywithiyzicoHelper::priceParser($shipping);
