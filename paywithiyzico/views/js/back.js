...
$(document).ready(function() {
    $("#module_form").submit(function(a) {
        var e, i, r;
        if (e = $("#paywithiyzico_api_type").val(), i = $("#paywithiyzico_api_key").val(), r = $("#paywithiyzico_api_secret_key").val(), "" != i && "" != r || alert("Api Key ve Secret Key Boş Bırakılamaz !"), "https://sandbox-api.paywithiyzico.com" == e) {
            if ("sandbox-" == i.substring(0, 8) && "sandbox-" == r.substring(0, 8)) return;
            alert("Sandbox / Test API için Live API Anahtarları kullanılamaz !")
        } else if ("https://api.paywithiyzico.com" == e) {
            if ("sandbox-" != i.substring(0, 8) && "sandbox-" != r.substring(0, 8)) return;
