...
<div class="panel">
	<p class="text-muted">
		...
		<div class="panelBox">
		    ...
		    <p><a href="https://merchant.paywithiyzico.com">https://merchant.paywithiyzico.com</a> adresi üzerinden müşteri bilgileriniz ile giriş yapınız. Panele eriştiğiniz sırada sağ üst köşede profil bilgilerinizi göreceksiniz. Profil bilgilerinizin üzerine tıkladıktan sonra “<strong>Ayarlar</strong>” menüsüne tıklayınız. “<strong>API Anahtları</strong>" alanından “<strong>API Anahtarı ve Güvenlik Anahtarı</strong>" bilgilerinizi kopyalayıp Opencart paywithiyzico modülü panelinde bulunan “<strong>API Anahtarı</strong>” ve “<strong>Güvenlik Anahtarı</strong>” alanlarına yapıştırınız..</p>
		    <ul>
		        <li><strong>Sandbox API</strong></li>
		    </ul>
		    <p><a href="https://sandbox-merchant.paywithiyzico.com">https://sandbox-merchant.paywithiyzico.com</a> adresi üzerinden müşteri bilgileriniz ile giriş yapınız. Panele eriştiğiniz sırada sağ üst köşede profil bilgilerinizi göreceksiniz. Profil bilgilerinizin üzerine tıkladıktan sonra “<strong>Ayarlar</strong>” menüsüne tıklayınız. “<strong>API Anahtları</strong>" alanından “<strong>API Anahtarı ve Güvenlik Anahtarı</strong>" bilgilerinizi kopyalayıp Opencart paywithiyzico modülü panelinde bulunan “<strong>API Anahtarı</strong>” ve “<strong>Güvenlik Anahtarı</strong>” alanlarına yapıştırınız..</p>
		    <p>Test ortamımız için <a href="https://sandbox-merchant.paywithiyzico.com/login">https://sandbox-merchant.paywithiyzico.com/login</a>  adresinden kayıt olup hemen sonrasında(mail onaysız) login olabiliyorsunuz.  Sandbox’ı test ederken <a href="https://dev.paywithiyzico.com/tr/test-kartlari">https://dev.paywithiyzico.com/tr/test-kartlari</a> adresindeki test kartlarını kullanabilirsiniz.</p>
		</div>
		...
		<div class="panelBox">
		    ...
		    <p>Bizimle iletişime geçebilirsiniz. Destek için: <a href="mailto:destek@paywithiyzico.com" target="_top">destek@paywithiyzico.com</a>
		</div>
	</p>
</div>
