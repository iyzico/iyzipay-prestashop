...
{/if}
	...
	<br /><br />{l s='If you have questions, comments or concerns, please contact our' mod='paywithiyzico'} <a href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}">{l s='expert customer support team.' mod='paywithiyzico'}</a>
</p>
{else}
<h3>{l s='Your order on %s has not been accepted.'  mod='paywithiyzico'}</h3>
<p>
	<br />- {l s='Reference' mod='paywithiyzico'} <span class="reference"> <strong>{$reference|escape:'html':'UTF-8'}</strong></span>
