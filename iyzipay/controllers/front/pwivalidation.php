...
class IyzipayPwivalidationModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        $paymentResponse = $this->module->payWithIyzicoInitialize(['cart' => $cart, 'cookie' => $this->context->cookie]);
        ...
        // Redirect to Pay with iyzico page
        if (isset($paymentResponse) && $paymentResponse->getStatus() === 'success') {
            $this->context->cookie->iyziPaymentType = 'pwi'; // Pay with iyzico tipini belirt
            Tools::redirect($paymentResponse->getPayWithIyzicoPageUrl());
            exit;
        } else {
