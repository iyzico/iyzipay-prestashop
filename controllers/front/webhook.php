...
class IyzicocheckoutformWebhookModuleFrontController extends ModuleFrontController {
    ...
    public function iyzicoWebhookResponse(){
        $iyzicoCallback = new IyzicocheckoutformResultModuleFrontController();
        $responseCode = $iyzicoCallback->initResult("webhook", $this->token);
        return $responseCode;
    }
